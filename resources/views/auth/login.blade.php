    ...
    <div class="py-6">
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            ...
            <div class="w-full p-8 lg:w-1/2">
                <h2 class="text-2xl font-semibold text-gray-700 text-center">Fellowship Apostle</h2>
                ...
                <form action="{{ route('guest:login') }}" method="post"
                    ...
                    <button class="px-4 py-3 w-5/6 text-center uppercase tracking-wider text-gray-600 font-bold">
                        Demo Link
                    </button>
                </form>
